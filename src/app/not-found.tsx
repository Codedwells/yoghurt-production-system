	...
	return (
		<>
			<section className="flex min-h-screen flex-col">
				<div className="mb-24 px-4 py-12 md:container lg:mb-0 lg:px-32">
					<div className="inline-flex w-full flex-col items-center justify-start gap-10">
						<div className="border-htractor-hibiscus h-[550px] w-full rounded-lg border">
							<div className="border-htractor-hibiscus/30 flex items-center justify-between border-b p-8">
								<div className="block">
									<svg
										width={204}
										height={18}
							...
							<div className="relative flex h-[calc(550px-85px)] flex-col items-center justify-center">
								...
								<div className="mt-5 block text-center">
									<h5 className="mb-1.5 text-lg font-medium leading-8 text-gray-900 md:text-xl">
										<span className="text-htractor font-semibold ">Oops!</span>
										&nbsp; It seems like you&apos;ve taken a wrong turn
									</h5>
									<p className="text-sm text-gray-500">
										Continue checking out our models
									</p>
									<Link
										href="/"
										className={cn(
